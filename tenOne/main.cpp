...
public:
    ...
    Vehicle(int Aw, int Ats, long Akm);
...
public:
    ...
    Car(int weight, int top_speed, long driven_km,
        string carBrand, string carModel, string carRegisterNo, bool carRunning = false);
...
Car::Car(int weight, int top_speed, long driven_km,
         string carBrand, string carModel, string carRegisterNo, bool carRunning):
        Vehicle(weight,top_speed, driven_km)
{
    brand = std::move(carBrand);
    model = std::move(carModel);
    register_no = std::move(carRegisterNo);
    running = carRunning;
}
